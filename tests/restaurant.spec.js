...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    assert.deepStrictEqual(request, meuRestaurante);
    ...
    // ```
    const menuReturn = objetoRetornado.consumption;
    const returnExpected2 = [];
    assert.deepStrictEqual(menuReturn, returnExpected2);
    ...
    const returnExpected3 = ['coxinha'];
    // ```
    assert.deepStrictEqual(objetoRetornado.consumption, returnExpected3);
