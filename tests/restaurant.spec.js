...
// console.log(createMenu(objetoQualquer).fetchMenu());
/*
...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    objetoRetornado5.consumption; // Retorno: ["coxinha", "agua", "sopa", "sashimi"]
    assert.deepStrictEqual(objetoRetornado5.consumption, [
      'coxinha',
      'agua',
      'sopa',
      'sashimi',
    ...
    objetoRetornado6.order('coxinha');
    objetoRetornado6.comsuption; // Retorno: ['coxinha', 'agua', 'coxinha']
    assert.deepStrictEqual(objetoRetornado5.consumption, [
      'coxinha',
      'agua',
      'coxinha',
    ...
    objetoRetornado7.order('coxinha');
    assert.deepStrictEqual(objetoRetornado7.pay(), 12.87 )
    // ```
