...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(objetoRetornado2.fetchMenu(), objetoQualquer);
    ...
    assert.deepStrictEqual(objetoRetornado3.comsumption, []);
    ...
    assert.deepStrictEqual(objetoRetornado4.comsumption, ["coxinha"]);
    ...
    assert.deepStrictEqual(objetoRetornado4.comsumption, ["coxinha", "agua", "sopa", "sashimi"]);
    ...
    assert.deepStrictEqual(objetoRetornado4.comsumption, ["coxinha", "agua", "sopa", "sashimi", "agua", "coxinha"]);
    ...
    const criarMenu = createMenu(menuExemplo);
    criarMenu.order('coxinha');
    criarMenu.order('agua');
    criarMenu.order('coxinha');

    assert.deepStrictEqual(parseFloat(criarMenu.pay().toFixed(2)), 12.87);
