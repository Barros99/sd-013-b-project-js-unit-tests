...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(typeof (createMenu({ food: {}, drink: {} }).fetchMenu()), 'object');
    ...
    // ```
    assert.deepStrictEqual(restaurant.fetchMenu(), { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    ...
    restaurant.order('coxinha');
    restaurant.order('agua');
    assert.deepStrictEqual(restaurant.consumption, ['coxinha', 'agua', 'sopa', 'coxinha', 'agua']);
    ...
    // ```
    assert.deepStrictEqual(restaurant.pay(), '28.05');
