...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    const objetoTeste = createMenu( { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
    assert.strictEqual(typeof objetoTeste, 'object');
    assert.strictEqual(typeof objetoTeste.fetchMenu, 'function');
    ...
    assert.deepStrictEqual(objetoRetornado2.fetchMenu(), { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} });
