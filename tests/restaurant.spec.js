...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    assert.deepStrictEqual(createMenu({ item: 'um', item2: 'dois' })['fetchMenu'](), { item: 'um', item2: 'dois' })
    ...
    // ```
    assert.deepStrictEqual(createMenu({ item: 'um', item2: 'dois' }).consumption, []);
    ...
    // ```
    const meuRestaurante = createMenu({ food: {}, drinks: {}, });
    meuRestaurante.order('coxinha')
    assert.deepStrictEqual(['coxinha'], meuRestaurante.consumption);
    ...
    assert.deepStrictEqual(['coxinha', 'agua', 'sopa', 'sashimi'], meuRestaurante.consumption);
    ...
    // ```
    meuRestaurante.order('coxinha');
    assert.deepStrictEqual(['coxinha', 'agua', 'sopa', 'sashimi', 'coxinha'], meuRestaurante.consumption);
