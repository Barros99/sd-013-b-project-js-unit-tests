...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(objetoRetornado3.comsumption, []);
    ...
    assert.deepStrictEqual(objetoRetornado3.comsumption, ["coxinha"]);
    ...
    assert.deepStrictEqual(objetoRetornado3.comsumption, ["coxinha", "agua", "sopa", "sashimi"]);
    ...
    assert.deepStrictEqual(objetoRetornado.comsumption, ['coxinha', 'agua', 'coxinha']);
