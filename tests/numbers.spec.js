...
// stricEqual (comparador === para variaveis simples) (valor devolvido pela função que estou testando === valor que eu espero)
// Ex; 1 === 2
// deepStrictEqual (comparador === para array e objetos)
// Ex: [1,2,3] === [2,5,6]
