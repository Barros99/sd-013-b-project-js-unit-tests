...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.deepStrictEqual(Array.isArray(productDetails('hamburguer', 'coca')), true);
    ...
    assert.notDeepStrictEqual(productDetails('Alcool Gel', 'Mascara')[0],productDetails('hamburguer', 'coca')[1]);
