...
//   const menu = {
//     fetchMenu: () => myMenu,
//     order: (request) => orderFromMenu(request, menu.consumption),
//     consumption: [],
//   };
//   return menu;
// };

// const orderFromMenu = (request, consumptionList) => {
//   consumptionList.push(request);
// }

// createMenu({a:'b'}).order("coxinha");
